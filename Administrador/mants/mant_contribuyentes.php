                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="firstName" Value="<?php echo $apellido; ?>" name="apellido" required>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="firstName" Value="<?php echo $telefono; ?>" name="telefono" required>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="firstName" class="form-label">Correo / Usuario*</label>
                                            <input type="text" class="form-control" id="firstName" Value="<?php echo $correo; ?>" name="correo" required>
                                        </div>
                                        <div class="col-sm-12">
...
<?php
    ...
    $correo = $_POST['correo'];
    $direccion = $_POST['direccion'];
    $consulta = $conn->actualizar("cliente", "nombres='$nombre',apellidos='$apellido',nic='$nic',medidor='$medidor',telefono='$telefono',correo='$correo',direccion='$direccion'", "id_cliente=$id_update");
