<?php
    ...
    $pdf->Cell(50,6,'Direccion',1,1,'C',1);
	
	$pdf->SetFont('Arial','',10);
	//datos a mostrar de la tabla
	foreach ($consulta_alumnos as $datos) {
		$pdf->Cell(30,6,$datos['nombres'],1,0,'C');
        $pdf->Cell(30,6,$datos['apellidos'],1,0,'C');
        $pdf->Cell(20,6,$datos['dui'],1,0,'C');
        $pdf->Cell(25,6,$datos['fechaNacimiento'],1,0,'C');
		$pdf->Cell(30,6,$datos['dui'],1,0,'C');
		$pdf->Cell(50,6,$datos['direccion'],1,1,'C');
    }
